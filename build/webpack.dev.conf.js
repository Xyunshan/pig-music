...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    before(app) {
      // 歌单详情
      app.get('/api/getSheetList', function (req, res) {
      ...
      // 专辑详情
      app.get('/api/getAlbumDetail', function (req, res) {
        var url = 'https://c.y.qq.com/v8/fcg-bin/fcg_v8_album_info_cp.fcg'
        axios.get(url, {
          headers: {
            referer: 'https://y.qq.com/n/yqq/album/',
            host: 'c.y.qq.com'
          },
          params: req.query
        }).then((response) => {
      ...
      // 搜索提示
      app.get('/api/getSearchTips', function (req, res) {
